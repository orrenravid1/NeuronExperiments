...
#define mg _ml->template fpfield<2>(_iml)
#define mg_columnindex 2
#define alpha_mg _ml->template fpfield<3>(_iml)
#define alpha_mg_columnindex 3
#define beta_mg _ml->template fpfield<4>(_iml)
#define beta_mg_columnindex 4
#define i _ml->template fpfield<5>(_iml)
#define i_columnindex 5
#define mgblock _ml->template fpfield<6>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	...
 	e = _parm_default[1]; /* 0 */
 	mg = _parm_default[2]; /* 1 */
 	alpha_mg = _parm_default[3]; /* 0.062 */
 	beta_mg = _parm_default[4]; /* 3.57 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"mg"} /* 2 */,
                                       _nrn_mechanism_field<double>{"alpha_mg"} /* 3 */,
                                       _nrn_mechanism_field<double>{"beta_mg"} /* 4 */,
                                       _nrn_mechanism_field<double>{"i"} /* 5 */,
                                       _nrn_mechanism_field<double>{"mgblock"} /* 6 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NMDA_Channel C\n");
